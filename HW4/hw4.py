...
def at_least_one_color(n, k):
    clause = []
    for color_idx in range(1, k + 1):
        variable = node2var(n, color_idx, k)
...
def at_most_one_color(n, k):
    ...
    for i in range(1, k + 1):
        for j in range(i + 1, k + 1):
            ...
            clause_list.append([-var_i, -var_j])
    return clause_list
...
def generate_node_clauses(n, k):
    ...
    clause_list.extend(at_most_one_color(n, k))
    return clause_list
